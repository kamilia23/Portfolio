...
function Education({ lang }) {
  const content = {
    fr: {
      ...
      degree3: 'Première année licence en tronc commun mathématiques et informatique (MI)',
    ...
    en: {
      ...
      degree3: 'First year license in common core mathematics and computer science (MC)',
